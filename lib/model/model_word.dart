...
List<ModelWord> modelWordFromJson(String str) => List<ModelWord>.from(json.decode(str).map((x) => ModelWord.fromJson(x)));

String modelWordToJson(List<ModelWord> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ModelWord {
  ...
  ModelWord.fromJson(Map<String, dynamic> json) {
    word = json['word'];
